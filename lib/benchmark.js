...
const MAX_RECOMMENDED_MODULES = 19; // was 3 (SkillsBench's "complexity contract": 2-3 modules is optimal),
// raised to accommodate skills whose supporting files genuinely belong together (e.g. a
// template + its PWA install assets: manifest/service-worker/icons) rather than scope creep —
// still a real ceiling, just less aggressive than the original heuristic.
